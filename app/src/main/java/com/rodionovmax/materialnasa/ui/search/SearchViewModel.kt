...
class SearchViewModel(
    ...
    init {
        ...
        pagingDataFlow = searches
            .flatMapLatest { searchRes(queryString = it.query) }
    ...
    private fun searchRes(queryString: String): Flow<PagingData<UiModel>> =
        repository.getSearchResultStream(queryString)
            .map { pagingData -> pagingData.map { UiModel.ResItem(it) } }
            .map {
...
sealed class UiModel {
    data class ResItem(val res: SearchResult) : UiModel()
    data class SeparatorItem(val description: String) : UiModel()
}

private val UiModel.ResItem.roundedStarCount: Int
    get() = this.res.id/* / 10_000*/

private const val LAST_QUERY_SCROLLED: String = "last_query_scrolled"
private const val LAST_SEARCH_QUERY: String = "last_search_query"
private const val DEFAULT_QUERY = "Apollo"
